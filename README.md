...
![mall모델](https://user-images.githubusercontent.com/75401918/100956690-5688c780-355c-11eb-8544-1548931f1ac0.jpg)
# 예제 - 음식배달
...
1. 장애격리
    ...
    1. 예약이 과중되면 사용자를 잠시동안 받지 않고 결제를 잠시후에 하도록 유도한다  Circuit breaker, fallback
1. 성능
    1. 사용자가 예약 또는 대출한 도서 목록을 확인하여 해당 도서의 상태를 확인할 수 있어야 한다.  CQRS
    1. 도서대출 상태가 바뀔때마다 카톡 등으로 알림을 줄 수 있어야 한다  Event driven
